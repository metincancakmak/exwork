...
--
-- Anamakine: 127.0.0.1
-- Üretim Zamanı: 14 Haz 2023, 19:48:24
...
CREATE TABLE `departman` (
  ...
  `departman_adi` varchar(55) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_turkish_ci;

-- --------------------------------------------------------

--
-- Tablo için tablo yapısı `dpgorev`
--

CREATE TABLE `dpgorev` (
  `dpgorev_id` int(11) NOT NULL,
  `dpgorev_adi` varchar(55) NOT NULL,
  `departman_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_turkish_ci;
...
CREATE TABLE `firma` (
  ...
  `firma_adi` varchar(55) NOT NULL,
  `firma_yetkili` varchar(55) NOT NULL,
  `firma_mail` varchar(55) NOT NULL,
  `firma_telefon` varchar(11) NOT NULL,
  `firma_sehir` varchar(55) NOT NULL,
  `firma_ilce` varchar(55) NOT NULL,
...
CREATE TABLE `gorevler` (
  ...
  `firma_id` varchar(5) NOT NULL,
  `personel_id` varchar(5) NOT NULL,
  `gorev_tur` varchar(30) NOT NULL,
  `gorev` varchar(2500) NOT NULL,
  `verilis_tarih` date NOT NULL,
  `son_tarih` date NOT NULL,
  `tamamlandimi` varchar(10) NOT NULL,
  `tamamlanma_tarih` varchar(55) NOT NULL,
  `puan` varchar(5) NOT NULL,
  `gorev_sonuc` varchar(2500) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_turkish_ci;
...
--
-- Tablo için indeksler `dpgorev`
--
ALTER TABLE `dpgorev`
  ADD PRIMARY KEY (`dpgorev_id`);
...
--
ALTER TABLE `ajanda`
  MODIFY `ajanda_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
...
--
-- Tablo için AUTO_INCREMENT değeri `dpgorev`
--
ALTER TABLE `dpgorev`
  MODIFY `dpgorev_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- Tablo için AUTO_INCREMENT değeri `firma`
--
ALTER TABLE `firma`
  MODIFY `firma_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- Tablo için AUTO_INCREMENT değeri `gorevler`
--
ALTER TABLE `gorevler`
  MODIFY `gorev_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=50;
